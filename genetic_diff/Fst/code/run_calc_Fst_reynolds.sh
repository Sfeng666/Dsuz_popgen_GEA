...
min_count=$2
window_heter=$3
wd=/home/siyuan/jobs/suzukii_WGS/genetic_diff/Fst/ungapped_window_efs/winheter_$window_heter\_mincov_$mincov\_mincount_$min_count
