...
usage="## this script generate 4-fold synonymous SNP data.\n
...
# min_freq=0
# miss_frac=0.001
snp_clean_syn_contig=$wd/{}_snp_clean_syn.vcf
mpileup_syn_contig=$wd/{1}_syn_mpileup
