...
in_script='/home/siyuan/jobs/suzukii_WGS/EAA/downstream/GSEA/random_SNP/scripts/output_gene_list/all_trimmed_outliers/scripts/GO_SNP_parallel_genomic_permutation_modifiedsuz.pl'
out_script='/home/siyuan/jobs/suzukii_WGS/EAA/downstream/GSEA/random_SNP/scripts/output_gene_list/all_trimmed_outliers/scripts/GO_SNP_parallel_genomic_permutation_modifiedsuz_{0}.pl'

# 1. get the name of contigs that contain analyzed SNP
for env_var in env_vars:
    contigs = {}
    cmd = "echo {0}/{1}_0.9/fst_signif_qval0.05_{1}_*".format(dir_GEA, env_var)
